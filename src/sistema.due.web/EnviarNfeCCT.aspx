<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Async="true" CodeBehind="EnviarNfeCCT.aspx.cs" Inherits="Sistema.DUE.Web.ConsultarNFs_Banco" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    <script>
        ...
        function ImportarNFs(lista, total, guidUsuario) {
            ...
            $.ajax({
                type: "POST",
                url: "ConsultarNFs_Banco.aspx/ImportarNFs",
        ...
        function ObterTotalNFsInseridas(guidUsuario) {
            ...
            $.ajax({
                type: "POST",
                url: "ConsultarNFs_Banco.aspx/ObterTotalNFsImportadas",
                data: JSON.stringify(postData),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function LimparGUID() {
            ...
            if (guidUsuario !== "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "ConsultarNFs_Banco.aspx/ExcluirGUID",
                    data: JSON.stringify(postData),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function () {
